...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        ...
        @include('admin.includes.breadcrumb', ['title'=>'Color'])
            ...
            <a href="{{Route('color.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">ALL Color Info</h5>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('color.show',$item->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info" data-toggle="tooltip" title="">View</a> 

                                    <a href="{{route('color.edit',$item->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-warning" data-toggle="tooltip" title="">Edit</a> 

                                    <a type="button" href="{{route('color.destroy',['color'=>$item->id])}}"                                     
