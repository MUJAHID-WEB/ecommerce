...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        ...
        <a href="{{Route('status.index')}}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> ALL INFO</a>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="serial" value="{{$status->serial}}" class="form-control"> 
                                <span class="text-denger serial"></span>
                            </div>
                        </div>
                    </div>
