                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" value="{!!$publication->description!!}" name="description" rows="4"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <img src="/{{$publication->image}}" height="50" width="50" alt="image">
                            </div>
                        </div>
                        <!--/span-->
                    </div>
