...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        ...
        @include('admin.includes.breadcrumb', ['title'=>'Sub Category'])
            ...
            <a href="{{Route('sub_category.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
        </div>
    </div>
</div>
                    ...
                    <table class="table product-overview">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->main_category_info ? $item->main_category_info->name : '' }}</td>
                                
                                <td>
                                    <img src="/{{$item->icon}}" alt="logo" width="50">
                                </td>
                                <td>{{$item->created_at->format('d M S h:i:s a')}}</td>
                                <td>
                                    
                                    <a href="{{route('sub_category.show',$item->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-info" data-toggle="tooltip" title="">View</a> 

                                    <a href="{{route('sub_category.edit',$item->id)}}" class="btn waves-effect waves-light btn-rounded btn-xs btn-warning" data-toggle="tooltip" title="">Edit</a> 

                                    <a type="button" href="{{route('sub_category.destroy',['sub_category'=>$item->id])}}"                                     
