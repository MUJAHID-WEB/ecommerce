...
<head>
    ...
    <!-- chartist CSS -->
    @stack('ccss')
    <link href="{{asset('contents/admin')}}/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
    <link href="{{asset('contents/admin')}}/dist/css/pages/ecommerce.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{asset('contents/admin')}}/dist/css/style.min.css" rel="stylesheet">
    
    
    <script src="{{asset('contents/admin')}}/assets/node_modules/jquery/jquery-3.2.1.min.js"></script>
    ...
    <script>
        ...
        $(document).ajaxSuccess((e,res)=>
            console.log((res.responseJSON && res.responseJSON)||res));
...
<body class="skin-default fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © 2021 Developed by Mujahidul islam
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <script src="{{asset('contents/admin')}}/assets/node_modules/popper/popper.min.js"></script>
    <script src="{{asset('contents/admin')}}/assets/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{asset('contents/admin')}}/dist/js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="{{asset('contents/admin')}}/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="{{asset('contents/admin')}}/dist/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="{{asset('contents/admin')}}/assets/node_modules/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <script src="{{asset('contents/admin')}}/assets/node_modules/sparkline/jquery.sparkline.min.js"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('contents/admin')}}/dist/js/custom.min.js"></script>
    <script src="{{asset('contents/admin')}}/assets/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    <script src="{{asset('contents/admin')}}/assets/node_modules/raphael/raphael-min.js"></script>
    <script src="{{asset('contents/admin')}}/assets/node_modules/morrisjs/morris.min.js"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('contents/admin')}}/dist/js/ecom-dashboard.js"></script>
    @stack('cjs')
