                ...
                <div class="header-top-area bb hidden-xs">
                    <div class="container">
                        <div class="row">
                            ...
                            @include('website.ecommerce.layout.header_language')

                            <div class="col-xl-9 col-lg-9 col-md-9 col-12">
                                <div class="header-top-right">
                                    <p class="pull-left h2-color mtb-10 d-none d-md-block">Wellcome to Oneclick store! </p>
                                    
                                    @include('website.ecommerce.layout.header_right_links')
                ...
                <div class="header-bottom home3-bg">
                    <div class="container">
                        <div class="row">
                            ...
                            @include('website.ecommerce.layout.menu_sidebar')

                            <div class="col-xl-7 col-lg-6 col-md-8 col-12">
                                
                                @include('website.ecommerce.layout.search')

                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-4  col-12">
                                
                                @include('website.ecommerce.layout.header_cart')
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                <div class="footer-widget">
                                    ...
                                    <div class="footer-content">
                                        <p>eBazar & Shopping is a trustworthy eCommerce site.</p>
                                        <ul>
                                            <li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="copyright">
                                    <span>Copyright &copy; 2021 <a href="#">eBazar & Shopping</a> All Rights Reserved.</span>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="mayment text-right">
                                    <a href="mujahidweb.xyz">
                                        Developed By Md. Mujahidul Islam
                                    </a>
                                </div>
                            </div>
                        </div>
